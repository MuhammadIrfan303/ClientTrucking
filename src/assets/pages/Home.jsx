                            ...
                            <div className="p-8 md:p-12 flex flex-col justify-center">
                                ...
                                <div className="mt-6 grid grid-cols-1 md:grid-cols-2 gap-4">
                                    <div className="flex items-start gap-3">
                                        <div className="bg-[#4372ac]/20 p-2 rounded-lg">
                                            <svg className="w-5 h-5 text-[#4372ac]" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                                <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M12 8v4l3 3m6-3a9 9 0 11-18 0 9 9 0 0118 0z" />
                                            </svg>
                                        </div>
                                        <div>
                                            <h4 className="text-white font-semibold">Instant Responses</h4>
                                            <p className="text-gray-400 text-sm">Get answers in seconds, not hours</p>
                                        </div>
                                    </div>
                                    ...
                                    <div className="flex items-start gap-3">
                                        ...
                                        <div>
                                            <h4 className="text-white font-semibold">100% Accurate</h4>
                                            <p className="text-gray-400 text-sm">Real-time pricing and regulations</p>
                                        </div>
                                    </div>
                                </div>
